  ...
  return (
    <section className="app-video__container" id="video">
      ...
      <div className="app-video__container-controls" onClick={onPlay}>
        ...
        <Button onClick={onPlay} icon="pi pi-play" className="p-button-rounded p-button-warning p-button-text" aria-label="Play"/>
        <Button onClick={onFullScreen} icon="pi pi-external-link" className="p-button-rounded p-button-warning p-button-text" aria-label="Fullscreen" />
        </div>
      </div>
    </section>
  );
...
const Admin: React.FC<IServices> = (props) => {
  ...
  return (
    <section className="app-admin__container">
      {/* <Dialog
        header="Header"
        visible={openD}
        style={{ width: "550px" }}
        ...
        <form className="app-createform__container" onSubmit={onSubmit}>
          <div className="app-createform__container-field">
            <span className="p-float-label p-input-icon-right">
              <InputText name='family' onChange={handleChange} className="w-100" value={data.family}/>
              <label>Nombre</label>
            </span>
          </div>
...
const AddMember: React.FC<IServices> = ({ addMemeber, families }) => {
  ...
  const options = families.map(f => ({label: capitalized(f.family), value:f._id}))
  return (
    <Accordion>
      <AccordionTab header="Añadir Miembros">
        <form className="app-createform__container" onSubmit={onSubmit}>
          ...
          <div className="app-createform__container-field">
            <span className="p-float-label p-input-icon-right">
              <InputText name="name" value={data.name} onChange={handleChange} style={{
                width: '318px'
              }}/>
              <label>Nombre*</label>
            </span>
          ...
          <div className="app-createform__container-field">
            <span className="p-float-label p-input-icon-right">
            <InputText name="lastname" value={data.lastname} onChange={handleChange}style={{
                width: '318px'
              }}/>
